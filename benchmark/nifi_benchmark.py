...
IP_NIFI   = '10.28.8.70' # IP of Nifi cluster
...
for indexJson in range(1, len(jsonFile)):
    curr_mess_count = jsonFile[indexJson]['statusMetrics']['outputCount']
    prev_mess_count = jsonFile[indexJson - 1]['statusMetrics']['outputCount']
